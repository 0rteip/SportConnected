...
\begin{figure}[H]
    \includegraphics[width=\textwidth]{attivita.png}
    \centering
...
\begin{figure}[H]
    \includegraphics[width=\textwidth]{segm.png}
    \centering
...
\begin{figure}[H]
    \includegraphics[width=\textwidth]{riconoscimento.png}
    \centering
...
\begin{table}[h!]
    ...
    \renewcommand{\arraystretch}{1.5} % Altezza delle righe
    \begin{tabularx}{\textwidth}{
    >{\raggedright\arraybackslash}p{\dimexpr.15\linewidth-2\tabcolsep-1.3333\arrayrulewidth}% column 1
    >{\raggedright\arraybackslash}p{\dimexpr.65\linewidth-2\tabcolsep-1.3333\arrayrulewidth}% column 2
