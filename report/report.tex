...
\lstdefinestyle{sql}{
    ...
    numberstyle=\color{orange!100!black}, % Aggiungi questa linea per colorare i numeri
...
% #utilizzo la stessa query utilizzara per 05
...
\begin{figure}[H]
    \includegraphics[width=0.9\textwidth]{swappy-20230910_002421.png}
    \centering
...
\begin{figure}[H]
    \includegraphics[width=0.9\textwidth]{swappy-20230910_004239.png}
    \centering
