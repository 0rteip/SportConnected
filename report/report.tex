...
\begin{figure}[H]
    \includegraphics[width=0.8\textwidth]{svolgimento.png}
    \centering
...
\begin{figure}[H]
    \includegraphics[width=0.8\textwidth]{riconoscimento schema.png}
    \centering
...
\begin{figure}[H]
    \includegraphics[width=0.8\textwidth]{seguiti.png}
    \centering
...
\begin{figure}[H]
    \includegraphics[width=0.8\textwidth]{prestazioni.png}
    \centering
